...
const currentRepoName = process.env.CI === undefined ? execSync(
  ...
  presets: [
    [
      ...
      ({
        docs: {
          path: "../.docs",
          // Only serve src/pages/index.js for "nefino_li" repo and docs-only mode for all others
          // https://docusaurus.io/docs/docs-introduction#docs-only-mode
          ...(currentRepoName !== "nefino_li" && { routeBasePath: "/" }),
          ...
          sidebarItemsGenerator: async function ({defaultSidebarItemsGenerator, ...args}) {
            ...
            const objIndex = sidebarItems.findIndex((obj => obj.label === 'reference'))
            if (objIndex !== -1) {
        ...
        pages: {
          ...(currentRepoName !== "nefino_li" && {
            exclude: [
              // if it is not our main repo we wand docs-only mode and thus need to exclude the index.js file
              // https://docusaurus.io/docs/docs-introduction#:~:text=Copy-,CAUTION,-If%20you%20added
